...
const handleCreateNew = () => {
    Swal.fire({
        ...
        html: `
    <input id="swal-input-statement" class="swal2-input" placeholder="Enunciado" />
    <input id="swal-input-alternative1" class="swal2-input" placeholder="Alternativa 1" />
    <input id="swal-input-score1" class="swal2-input" placeholder="Score 1" />
    <input id="swal-input-alternative2" class="swal2-input" placeholder="Alternativa 2" />
    <input id="swal-input-score2" class="swal2-input" placeholder="Score 2" />
    <input id="swal-input-alternative3" class="swal2-input" placeholder="Alternativa 3" />
    <input id="swal-input-score3" class="swal2-input" placeholder="Score 3" />
  `,
        ...
        if (result.isConfirmed) {
            ...
            // Ahora puedes usar estos valores para crear una nueva pregunta
            createNewQuestion(
                statement,
                alternative1,
                score1,
